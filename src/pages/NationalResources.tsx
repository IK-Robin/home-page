const NationalResources = () => {
  ...
  const navItems = [
    ...
    { label: "ABOUT US", href: "https://www.hoardingcleanup.com/about_us", alt: "About Hoarding Cleanup, Clutter Cleanup" },
  ...
  const footerLinks = [
    ...
    { label: "About Us", href: "https://www.hoardingcleanup.com/about_us" },
