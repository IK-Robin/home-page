const Index = () => {
  ...
  const services = [
    "Live Call Center 8:00 AM to 5:00 PM All Time Zones (800) 462-7337",
    "Hoarding and Clutter Clean up",
    { text: "Biohazard Cleanup", url: "https://crimecleaners.com" },
    { 
      text: "Rodent Cleanup", 
      url: "https://rodentdroppingscleanup.com", 
      suffix: " & ", 
      link2: { text: "Pigeon Cleanup", url: "https://pigeondroppingscleanup.com" } 
    },
    ...
    "Itemized Inventory",
    "Deep Cleaning",
    "Home Repairs - Paint, Drywall, Carpet, Electrical, Plumbing, Etc.",
    "Additional Follow Up Care (home visits, meals, weekly cleaning/maintenance, therapists)",
  ];
                  ...
                  <li key={index} className="flex items-start gap-2">
                    ...
                    {typeof service === "string" ? (
                      ...
                      <span>
                        ...
                        {service.suffix}
                        <a href={service.link2.url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                          {service.link2.text}
                        </a>
                      </span>
                    ) : (
